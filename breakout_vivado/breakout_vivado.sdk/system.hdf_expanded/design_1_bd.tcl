...
proc create_root_design { parentCell } {
  ...
  set a_0 [ create_bd_port -dir O -from 3 -to 0 a_0 ]
  ...
  set t_0 [ create_bd_port -dir I -from 3 -to 0 t_0 ]
  ...
  # Create instance: task_07_0, and set properties
  set task_07_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:task_07:1.0 task_07_0 ]

  # Create instance: vga_control_0, and set properties
  set vga_control_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:vga_control:1.0 vga_control_0 ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports led_16bits] [get_bd_intf_pins axi_gpio_1/GPIO]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI] [get_bd_intf_pins vga_control_0/S00_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M06_AXI [get_bd_intf_pins microblaze_0_axi_periph/M06_AXI] [get_bd_intf_pins task_07_0/S00_AXI]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_ports Clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins mdm_1/S_AXI_ACLK] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/M06_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/Clk] [get_bd_pins rst_Clk_100M/slowest_sync_clk] [get_bd_pins task_07_0/s00_axi_aclk] [get_bd_pins vga_control_0/s00_axi_aclk]
  ...
  connect_bd_net -net rst_Clk_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins mdm_1/S_AXI_ARESETN] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/M06_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_Clk_100M/peripheral_aresetn] [get_bd_pins task_07_0/s00_axi_aresetn] [get_bd_pins vga_control_0/s00_axi_aresetn]
  connect_bd_net -net t_0_1 [get_bd_ports t_0] [get_bd_pins task_07_0/t]
  connect_bd_net -net task_07_0_a [get_bd_ports a_0] [get_bd_pins task_07_0/a]
  connect_bd_net -net vga_control_0_blue [get_bd_ports blue_0] [get_bd_pins vga_control_0/blue]
  connect_bd_net -net vga_control_0_green [get_bd_ports green_0] [get_bd_pins vga_control_0/green]
  connect_bd_net -net vga_control_0_hsync [get_bd_ports hsync_0] [get_bd_pins vga_control_0/hsync]
  connect_bd_net -net vga_control_0_red [get_bd_ports red_0] [get_bd_pins vga_control_0/red]
  connect_bd_net -net vga_control_0_vsync [get_bd_ports vsync_0] [get_bd_pins vga_control_0/vsync]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A40000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs task_07_0/S00_AXI/S00_AXI_reg] SEG_task_07_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00020000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs vga_control_0/S00_AXI/S00_AXI_reg] SEG_vga_control_0_S00_AXI_reg
