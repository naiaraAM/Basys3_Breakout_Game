...
#define VGA_CONTROL_S00_AXI_SLV_REG0_OFFSET 0
#define VGA_CONTROL_S00_AXI_SLV_REG1_OFFSET 4
#define VGA_CONTROL_S00_AXI_SLV_REG2_OFFSET 8
#define VGA_CONTROL_S00_AXI_SLV_REG3_OFFSET 12
 ...
 *
 * @param   BaseAddress is the base address of the VGA_CONTROLdevice.
 ...
 * @note
 * C-style signature:
 * 	void VGA_CONTROL_mWriteReg(u32 BaseAddress, unsigned RegOffset, u32 Data)
 *
 */
 ...
 * @note
 * C-style signature:
 * 	u32 VGA_CONTROL_mReadReg(u32 BaseAddress, unsigned RegOffset)
 *
 */
 ...
 *
 */
XStatus VGA_CONTROL_Reg_SelfTest(void * baseaddr_p);
